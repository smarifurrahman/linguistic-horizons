        ...
        <div className={`navbar w-[85%] mx-auto py-5 flex items-center font-bold px-0 ${currentPath === '/' ? 'absolute left-0 right-0 top-0 z-50 text-white' : 'text-dark'}`}>
            ...
            <div className="navbar-end">
                <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 px-2 pt-3 pb-5 shadow bg-dark bg-opacity-95 rounded-box w-[50vw] items-center justify-center">
                        {navItemsSmall}
                    </ul>
                </div>
